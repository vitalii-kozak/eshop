...
<ul id="main-menu">
    ...
    <li><form name="create order" action="ShoppingServlet" method="post"><input type="hidden" name="action" value="ORDER_CREATE_MENU_CLIENT"> <input class="myButtonMenu" type="submit" value="<c:message key="client_menu.OrderCreate"/>"></form></li><li> &nbsp; </li>
